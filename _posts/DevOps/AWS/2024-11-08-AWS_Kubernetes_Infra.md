...
# 목차
- [Intro](#intro)
- [쿠버네티스를 사용해 환경을 구축하기 위해 필요한 환경 세팅](#쿠버네티스를-사용해-환경을-구축하기-위해-필요한-환경-세팅)
    1. [인프라 구조도 작성](#1-인프라-구조도-작성)
    2. [관리 및 모니터링 도구 설정](#2-관리-및-모니터링-도구-설정)
    3. [네트워킹 및 보안 설정 방법](#3-네트워킹-및-보안-설정-방법)
    4. [코드형 인프라 (IaC)로 클라우드 포메이션을 활용한 구축](#4-cloudformation을-이용해-eks-클러스터-코드형-인프라iac-구축-예시)
    5. [EC2에서 별도로 쿠버네티스를 운용할 시 Teraform을 사용해 코드형 인프라(IaC) 구축 예시](#5-ec2에서-별도로-쿠버네티스를-운용할-시-teraform을-사용해-코드형-인프라iac-구축-예시)
- [Outro](#outro)
<br/><br/><br/><br/>
