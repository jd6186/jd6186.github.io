...
위와 같이 쿼리를 변경함으로써 <strong style="color: #bb4177;">서브 쿼리를 많이 제외</strong>한 것을 보실 수 있습니다.
변경 후 12번의 테이블 조인이 발생하던 기존 쿼리 대비 
> <img src="../../../assets/img/2022-07-26-Query_Tip_01/before.png"  width="700"/>

지금 쿼리는 10번의 조인만을 사용해 <strong style="color: #bb4177;">자원낭비를 줄였습니다.</strong><br/>
> <img src="../../../assets/img/2022-07-26-Query_Tip_01/after.png"  width="700"/>
기존과 비교하면 테이블 조인 시 <strong style="color: #bb4177;">Full Scan이 발생하지 않도록 조치</strong>가 되었습니다.
<br/>
