...
간단하죠? 위에서 살펴보았듯이 무언가를 연결해주는 기능을 하는 것이 스위치라고 불리는 L1, L2, L3... 입니다.
...
## 마무리
#### 준비 기간 
22.01.11 ~ 22.02.12 (약 한달)<br/>
말씀 드렸지만 다양한 AWS 서비스를 실제 사용해보면 실무 경험이 있는 상태에서 진행했기 때문에 빨리 취득했고 아니면 보통 3개월 정도 시간이 소요될 것 같습니다.
