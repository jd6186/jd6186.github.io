...
성능이 무척 뛰어나 V8엔진을 사용하는 Node.js 또는 GO 언어와 비견할 수 있을 정도입니다.
...
- 서버 및 랙 웹서버 선택<br/>
  ...
  - Server Gateway Interface<br/>
    공식 문서에 나와있는 Uvicorn 또는 Hypercorn 중에서 이번에는 <strong style="color: #bb4177;">'Hypercorn'</strong>을 선택하게 되었습니다.<br/>
    CLI로 설치해 주세요
